...
class SearchAgentEvaluationTest {
    ...
    void ragRecommendation_shouldBeRelevant() {
        ...
        String aiResponse = "For a premium gift, I'd recommend the Jingdezhen Celadon Teacup ($85.00) — "
                + "its traditional craftsmanship and elegant glaze make it perfect for elders. "
                + "The Longquan Celadon Tea Set ($120.00) is also excellent if budget allows.";
    ...
    void ragRecommendation_shouldBeFactual() {
        List<Document> retrievedProducts = List.of(
                new Document("Jingdezhen Celadon Teacup — handmade, traditional glaze, $85.00",
                        Map.of("name", "Jingdezhen Celadon Teacup", "price", "8500", "material", "celadon")),
                new Document("Longquan Celadon Tea Set — includes teapot and 6 cups, $120.00",
    ...
    void hallucination_shouldFailFactCheck() {
        List<Document> retrievedProducts = List.of(
                new Document("Blue-and-white bowl — Chinese classical style, $35.00",
                        Map.of("name", "Blue-and-white bowl", "price", "3500"))
        );
        String hallucinatedResponse = "I recommend the Royal Doulton Fine China Set ($500.00) — "
                + "a premium British porcelain collection perfect for formal dining. "
                + "Also consider the Wedgwood Jasperware Vase ($350.00).";
    ...
    void intentParsing_shouldBeRelevant() {
        String userQuery = "200 dollar budget celadon teacup for daily use";
        String intentJson = """
